...
<div id="table">
    <div id="dealer-area">
        <img id="dealer-avatar" src="badgarms.png" alt="Dealer Avatar">
        <h2>Dealer</h2>
...
<script>
// Insert your blackjack JavaScript logic here, unchanged from the working version.
// Ensure in endGame(win) you still have:
// if (!win) { document.getElementById('lose-img').classList.add('show'); setTimeout(()=>document.getElementById('lose-img').classList.remove('show'), 3000); }
</script>
